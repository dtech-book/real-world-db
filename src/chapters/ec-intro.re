...
本書では、実際のECシステムで使われているデータベース構造を眺めつつ、設計のポイントや良い点・悪い点について議論・解説していきます。
...
一度はOSSとしての開発が終了するのではといううわさがありましたが、2019年現在でも活発に開発が行われています。
...
EC-CUBEはバージョンによってデータベース構造が大きく異なりますが、今回はバージョン4.0を取り上げます。
...
今回取り上げるSpreeおよびEC-CUBEは、ネットショップを運用するためのECシステムです。

データベースの設計をするには、開発するサービスに関する深い業務知識が必要です。
...
想定外のフローにどこまで対応する必要があるか、できるべきかをよく考えることが、良い設計をするための鍵です。
